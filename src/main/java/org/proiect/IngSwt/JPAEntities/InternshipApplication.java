...
public class InternshipApplication {
    ...
    public InternshipApplication(Integer id, InternshipPosition internshipPosition, StudentInfo student, ApplicationStatus status, Integer grade, LocalDateTime appliedAt, String chatIds) {
        this.id = id;
